                ...
                <div class="col-lg-10 col-md-12">
                    <div class="card border-0 shadow-lg rounded-lg overflow-hidden">
                            ...
                            <div class="details-wrapper">
                                <div class="row">
                                    <div class="col-12 col-sm-6 mb-4">
                                        ...
                                        <p class="text-dark">{{ $customer->user->first_name }} {{ $customer->user->last_name }}</p>
                                    </div>
                                    <div class="col-12 col-sm-6 mb-4">
                                    ...
                                    <div class="col-12 col-sm-6 mb-4">
                                        ...
                                        <span class="badge badge-pill {{ $customer->user->is_banned ? 'badge-danger' : 'badge-success' }} px-3 py-2">
                                    ...
                                    <div class="col-12 mb-4">
                                        ...
                                        @if($addresses->isNotEmpty())
                                            <p class="text-dark">
                                                {{ $addresses->first()->street . ', ' . $addresses->first()->city . ', ' . $addresses->first()->state . ', ' . $addresses->first()->country . ' ' . $addresses->first()->postal_code }}
                                            </p>
                                            @if($addresses->count() > 1)
                                                <a href="#" data-toggle="modal" data-target="#addressesModal" class="text-primary">View all addresses</a>
                                            @endif
                                        @else
                        ...
                        <div class="card-footer bg-light border-top-0 p-4 d-flex justify-content-end align-items-center">
                            ...
                            <form action="{{ route('dashboard.customer.destroy', $customer->id) }}"
                                  method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
