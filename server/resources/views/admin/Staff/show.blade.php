...
@section('content')
                ...
                <div class="col-lg-10 col-md-12">
                    <div class="card border-0 shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div class="card-header bg-gradient-success text-white p-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <h2 class="mb-0 font-weight-bold text-capitalize">
                                    {{ $record->id . '. ' . $record->roles->pluck('name')[0] ?? 'N/A' }} /
                                    {{ $record->first_name . ' ' . $record->last_name ?? 'Staff Details' }}
                                </h2>
                                <div>
                                    <a href="{{ URL::previous() }}" class="btn btn-light btn-sm mr-2 rounded-pill px-3"
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6 mb-4">
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            @foreach ($record->specialties as $specialty)
                        ...
                        <div class="card-footer bg-light border-top-0 p-4 d-flex justify-content-end align-items-center">
                            ...
                            <form action="{{ route('dashboard.staff.destroy', $record->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
    ...
    <style>
        ...
        .details-wrapper {
            overflow: hidden;
            /* Ensures the details wrap around the floated image */
        }

        .clearfix {
            clear: both;
            /* Clears the float to ensure the footer isn't affected */
        }
    </style>
@endsection
