            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="logTypeFilter">
                        <a class="dropdown-item" href="{{ route('dashboard.logs.staff') }}">All Types</a>
                        <a class="dropdown-item" href="{{ route('dashboard.logs.staff', ['type' => 'info', 'search' => request()->input('search')]) }}">Info</a>
                        <a class="dropdown-item" href="{{ route('dashboard.logs.staff', ['type' => 'warning', 'search' => request()->input('search')]) }}">Warning</a>
                        <a class="dropdown-item" href="{{ route('dashboard.logs.staff', ['type' => 'error', 'search' => request()->input('search')]) }}">Error</a>
                    </div>
                </div>
            </div>

            <!-- Search form -->
            <form action="{{ route('dashboard.logs.staff') }}" method="GET">
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        ...
                        <a href="{{ route('dashboard.logs.staff') }}" class="btn btn-outline-secondary">Clear</a>
                        @endif
                    </div>
                </div>
            </form>
